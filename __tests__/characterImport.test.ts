...
jest.mock('../src/database/characterDatabase', () => ({
  ...
  setPendingCloudIdIfMissing: jest.fn(),
...
jest.mock('~/services/characterImageSyncService', () => ({
  ...
  reconcileCharacterImages: jest.fn(),
  promoteCharacterImagesToCloud: jest.fn(),
  demoteCharacterImagesToLocal: jest.fn(),
}))
