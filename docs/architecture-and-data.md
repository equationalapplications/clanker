...
Production and local dev migration workflow, the applied-migrations record, and how to author/record a new migration are documented in [Database Migrations](db-migrations.md).
