...
- Known caveat (`analytics/bq/README.md`): the Firebase native SDK can auto-log
  ...
  Raw GA4 aggregate totals _outside_ `v_purchases` (e.g. the GA4 UI, or any other
