...
- [Cloud character save + share](docs/CLOUD_CHARACTER_SAVE_SHARE.md) — Subscription-gated cloud save toggles, sharable character links/QR, and deep-link import flow.
