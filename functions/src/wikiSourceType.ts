...
export const VALID_SYNC_SOURCE_TYPES = new Set<string>([...LEGACY_SOURCE_TYPES, ...V4_SOURCE_TYPES])

/** Map client v4 source_type values to legacy Cloud SQL enum values. */
export function normalizeSourceTypeForStorage(sourceType: string | null | undefined): string {
...
export function normalizeSourceTypeForExport(sourceType: string | null | undefined): string | null {
